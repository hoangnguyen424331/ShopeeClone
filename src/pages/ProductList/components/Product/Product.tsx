      ...
      <div className='overflow-hidden rounded-sm bg-white shadow transition-transform duration-100 hover:translate-y-[-0.06rem] hover:shadow-md'>
        ...
        <div className='overflow-hidden p-2'>
          <div className='min-h-[32px] text-xs line-clamp-2'>
            Áo Len Nam Cổ Lọ Lông Cừu Cao Cấp Dày Dặn Mềm Mịn Cực Ấm Kiểu Dáng Hàn Quốc Form Rộng Faviti
          </div>
          <div className='mt-3 flex items-center'>
            <div className='m-w-[50%] truncate text-gray-500 line-through'>₫200.000</div>
